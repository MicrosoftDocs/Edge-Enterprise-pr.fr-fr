...
---
# <a name="microsoft-edge-identity-support-and-configuration"></a>Prise en charge et configuration des identités MicrosoftEdge
...
## <a name="how-users-can-sign-into-microsoft-edge"></a>Comment les utilisateurs se connectent à MicrosoftEdge
...
- vérifier que les utilisateurs disposent toujours d’un profil professionnel sur MicrosoftEdge. [Consulter NonRemovableProfileEnabled](./microsoft-edge-policies.md#nonremovableprofileenabled)
...
Un jeton d’actualisation principal (PRT) est une clé Azure AD utilisée pour l’authentification sur les appareils Windows10, iOS et Android. Il permet d’activer l’authentification unique (SSO) dans les applications utilisées sur ces appareils. Pour plus d’informations, consultez [Qu’est-ce qu’un jeton d’actualisation principal?](/azure/active-directory/devices/concept-primary-refresh-token).
...
- [Quatre étapes pour une fondation d’identité forte avec Azure ActiveDirectory](/azure/active-directory/hybrid/four-steps)
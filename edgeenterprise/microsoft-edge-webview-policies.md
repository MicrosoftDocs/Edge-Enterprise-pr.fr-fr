...
## <a name="available-policies"></a><span data-ttu-id="cf08f-108">Stratégies disponibles</span><span class="sxs-lookup"><span data-stu-id="cf08f-108">Available policies</span></span>
...
|[<span data-ttu-id="cf08f-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="cf08f-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="cf08f-118">Définir la préférence de l'ordre de recherche du canal de diffusion</span><span class="sxs-lookup"><span data-stu-id="cf08f-118">Set the release channel search order preference</span></span>|
  ...
  ## <a name="loader-override-settings-policies"></a><span data-ttu-id="cf08f-119">Politiques d'annulation des paramètres du chargeur</span><span class="sxs-lookup"><span data-stu-id="cf08f-119">Loader Override Settings policies</span></span>
  ...
  ### <a name="browserexecutablefolder"></a><span data-ttu-id="cf08f-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="cf08f-121">BrowserExecutableFolder</span></span>

  #### <a name="configure-the-location-of-the-browser-executable-folder"></a><span data-ttu-id="cf08f-122">Configurer l'emplacement du dossier de l'exécutable du navigateur</span><span class="sxs-lookup"><span data-stu-id="cf08f-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="cf08f-123">Versions prises en charge:</span><span class="sxs-lookup"><span data-stu-id="cf08f-123">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="cf08f-125">Description</span><span class="sxs-lookup"><span data-stu-id="cf08f-125">Description</span></span>
...
<span data-ttu-id="cf08f-128">Pour définir la valeur du chemin d'accès au dossier, fournissez un nom de valeur et une paire de valeurs.</span><span class="sxs-lookup"><span data-stu-id="cf08f-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="cf08f-129">Définissez le nom de la valeur à l'ID du modèle d'utilisateur de l'application ou au nom du fichier exécutable.</span><span class="sxs-lookup"><span data-stu-id="cf08f-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="cf08f-130">Vous pouvez utiliser le «\*» joker comme nom de valeur à appliquer à toutes les applications.</span><span class="sxs-lookup"><span data-stu-id="cf08f-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="cf08f-131">Fonctionnalités prises en charge:</span><span class="sxs-lookup"><span data-stu-id="cf08f-131">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="cf08f-135">Type de données:</span><span class="sxs-lookup"><span data-stu-id="cf08f-135">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="cf08f-137">Informations et paramètres Windows</span><span class="sxs-lookup"><span data-stu-id="cf08f-137">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="cf08f-138">Informations relatives à la stratégie de groupe (ADMX)</span><span class="sxs-lookup"><span data-stu-id="cf08f-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="cf08f-144">Paramètres du Registre Windows</span><span class="sxs-lookup"><span data-stu-id="cf08f-144">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="cf08f-149">Exemple de valeur:</span><span class="sxs-lookup"><span data-stu-id="cf08f-149">Example value:</span></span>
...
```
  ...
  ### <a name="releasechannelpreference"></a><span data-ttu-id="cf08f-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="cf08f-151">ReleaseChannelPreference</span></span>

  #### <a name="set-the-release-channel-search-order-preference"></a><span data-ttu-id="cf08f-152">Définir la préférence de l'ordre de recherche du canal de diffusion</span><span class="sxs-lookup"><span data-stu-id="cf08f-152">Set the release channel search order preference</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="cf08f-153">Versions prises en charge:</span><span class="sxs-lookup"><span data-stu-id="cf08f-153">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="cf08f-155">Description</span><span class="sxs-lookup"><span data-stu-id="cf08f-155">Description</span></span>
...
<span data-ttu-id="cf08f-158">Pour définir la valeur de la préférence de canal de diffusion, fournissez un nom de valeur et une paire de valeurs.</span><span class="sxs-lookup"><span data-stu-id="cf08f-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="cf08f-159">Définissez le nom de la valeur à l'ID du modèle d'utilisateur de l'application ou au nom du fichier exécutable.</span><span class="sxs-lookup"><span data-stu-id="cf08f-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="cf08f-160">Vous pouvez utiliser le «\*» joker comme nom de valeur à appliquer à toutes les applications.</span><span class="sxs-lookup"><span data-stu-id="cf08f-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="cf08f-161">Fonctionnalités prises en charge:</span><span class="sxs-lookup"><span data-stu-id="cf08f-161">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="cf08f-165">Type de données:</span><span class="sxs-lookup"><span data-stu-id="cf08f-165">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="cf08f-167">Informations et paramètres Windows</span><span class="sxs-lookup"><span data-stu-id="cf08f-167">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="cf08f-168">Informations relatives à la stratégie de groupe (ADMX)</span><span class="sxs-lookup"><span data-stu-id="cf08f-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="cf08f-174">Paramètres du Registre Windows</span><span class="sxs-lookup"><span data-stu-id="cf08f-174">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="cf08f-179">Exemple de valeur:</span><span class="sxs-lookup"><span data-stu-id="cf08f-179">Example value:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="cf08f-181">Voir également</span><span class="sxs-lookup"><span data-stu-id="cf08f-181">See also</span></span>

...
---
# Configurer des stratégies de mode IE
...
### Activer l’intégration d’Internet Explorer en utilisant la fonctionnalité Stratégie de groupe
...
## Rediriger les sites de Microsoft Edge vers le mode IE
...
### Configurer des sites dans la liste des sites d’entreprise
...
- [Utiliser Enterprise Mode Site List Manager](https://docs.microsoft.com/internet-explorer/ie11-deploy-guide/use-the-enterprise-mode-site-list-manager)
...
### Configurer la stratégieUtiliser la liste des sitesweb en mode Entreprise IE
...
### Configurer l’utilisation de la stratégie Configurer la Liste des Sites en Mode Entreprise
...
### Configurer tous les sites intranet
...
## Rediriger des sites IE vers Microsoft Edge

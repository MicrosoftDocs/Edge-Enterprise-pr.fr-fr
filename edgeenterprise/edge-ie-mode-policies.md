...
3. (Facultatif) [Rediriger les sites d’IE vers Microsoft Edge](#redirect-sites-from-ie-to-microsoft-edge)
    ...
    1. Si vous êtes prêt à désactiver l’application IE11, suivez les étapes de [Désactiver Internet Explorer 11](/deployedge/edge-ie-disable-ie11)
    2. Sinon, suivez les autres étapes de la procédure [rediriger des sites d’IE à Microsoft Edge](/deployedge/edge-ie-mode-policies#redirect-sites-from-ie-to-microsoft-edge)
...
3. Cliquez **sur configuration utilisateur/configuration de l’ordinateur**  >  ** Modèles d’administration** >  **Microsoft Edge**.
...
2. Ouvrez l’Éditeur de stratégie de groupe.
3. Cliquez sur ** Configuration utilisateur/Configuration de l’ordinateur**  >  **Modèles d’administration**  >  ** composants Windows**  >  **Internet Explorer**.
...
2. Cliquez **sur configuration utilisateur/configuration de l’ordinateur**  >  ** Modèles d’administration** >  **Microsoft Edge**.
...
2. Cliquez sur**Configuration utilisateur/Configuration de l’ordinateur** > **Outils d’administration**  >  **Composants Windows** > **Internet Explorer**.
